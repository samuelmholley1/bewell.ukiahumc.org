      ...
      <div ref={printRef} className="flex justify-center">
        ...
        >
          ...
          <div
            ...
            style={{ height: '4%', backgroundColor: '#556B2F' }}
          >
          ...
          {/* Title — ~10% */}
          <div className="flex-shrink-0 text-center px-12" style={{ height: '10%' }}>
            ...
            <p style={{ fontSize: '20px', color: '#2B2B2B', opacity: 0.7, fontStyle: 'italic', fontFamily: '"Source Serif 4", Georgia, serif', marginTop: '8px' }}>
              A place of dignity for adults who need a little more care.
            </p>
          </div>

          {/* Divider — ~2% */}
          <div className="flex-shrink-0 flex items-center justify-center px-16" style={{ height: '2%' }}>
          ...
          {/* What We Offer — ~28% */}
          <div className="flex-shrink-0 px-14 pt-4" style={{ height: '28%' }}>
            <h2 style={{ fontSize: '28px', fontWeight: 700, color: '#556B2F', textAlign: 'center', fontFamily: '"Cormorant Garamond", serif', marginBottom: '16px' }}>
              What We Will Offer
            </h2>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px 40px', maxWidth: '580px', margin: '0 auto' }}>
              {[
          ...
          {/* Callout — ~15% */}
          <div className="flex-shrink-0 px-14" style={{ height: '15%' }}>
            <div style={{ backgroundColor: 'rgba(143,174,74,0.1)', borderLeft: '4px solid #8FAE4A', borderRadius: '0 8px 8px 0', padding: '20px 24px', maxWidth: '580px', margin: '0 auto' }}>
          ...
          {/* CTA — ~10% */}
          <div className="flex-shrink-0 text-center px-14" style={{ height: '10%' }}>
            <h2 style={{ fontSize: '28px', fontWeight: 700, color: '#556B2F', fontFamily: '"Cormorant Garamond", serif', marginBottom: '8px' }}>
          ...
          {/* Bottom contact bar — ~12% */}
          <div
            className="flex-shrink-0"
            style={{ height: '12%', backgroundColor: '#556B2F', padding: '20px 56px' }}
          >
